...
smd({
   ...
   smd({
     ...
     try {
       if (!_0x2712a3) {
         return _0x19ea9c.reply("*_Example : " + (prefix + _0x3da883) + " Marisel_*");
       }
   ...
   smd({
     ...
     try {
       if (!_0x4759ef) {
         return _0x3580cc.reply("*_Example : " + (prefix + _0x25c70f) + " Marisel_*");
       }
   ...
   smd({
     ...
     try {
       if (!_0x550c65) {
         return _0x33543a.reply("*_Example : " + (prefix + _0x5932cf) + " Marisel_*");
       }
   ...
   smd({
     ...
     try {
       if (!_0x30ff16) {
         return _0x177d36.reply("*_Example : " + (prefix + _0x51912b) + " Marisel_*");
       }
   ...
   smd({
     ...
     try {
       if (!_0x2049f9) {
         return _0x1c1874.reply("*_Example : " + (prefix + _0x5462f4) + " Marisel_*");
       }
   ...
   smd({
     ...
     try {
       if (!_0x3c787b) {
         return _0x435d39.reply("*_Example : " + (prefix + _0x4839f1) + " Marisel_*");
       }
